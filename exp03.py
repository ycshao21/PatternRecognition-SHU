...
def visualize_training_data(X, y, fisher, bayes):
    ...
    ax1.scatter(X[:, 0][y == 0], X[:, 1][y == 0], c="r", s=30, edgecolors="k")
    ax1.scatter(X[:, 0][y == 1], X[:, 1][y == 1], c="b", s=30, edgecolors="k")
    ax1.legend(LABELS)
    ax1.set_title("Fisher")
    # <<<<<<
    ...
    ax2.scatter(X[:, 0][y == 0], X[:, 1][y == 0], c="r", s=30, edgecolors="k")
    ax2.scatter(X[:, 0][y == 1], X[:, 1][y == 1], c="b", s=30, edgecolors="k")
    ax2.legend(LABELS)
    ax2.set_title("Bayes")
    # <<<<<<
